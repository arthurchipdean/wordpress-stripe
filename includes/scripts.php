...
function spire_load_stripe_scripts() {
    ...
    wp_enqueue_style('style', STRIPE_BASE_URL.'includes/css/style.css');
...
add_action('wp_enqueue_scripts', 'spire_load_stripe_scripts');
